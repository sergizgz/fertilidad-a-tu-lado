...
export default async function handler(req, res) {
  ...
  try {
        ...
        <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;color:#2A2A2A;">
          ...
          <div style="background:#FEF9FA;padding:32px;border-radius:0 0 12px 12px;border:1px solid #EDD5DC;">
            <table style="width:100%;border-collapse:collapse;font-size:15px;">
              <tr>
                <td style="padding:10px 0;color:#6B6B6B;width:160px;vertical-align:top;">Nombre</td>
              ...
              <tr style="border-top:1px solid #EDD5DC;">
                <td style="padding:10px 0;color:#6B6B6B;vertical-align:top;">Teléfono</td>
                <td style="padding:10px 0;">${telefono}</td>
              </tr>
              <tr style="border-top:1px solid #EDD5DC;">
                <td style="padding:10px 0;color:#6B6B6B;vertical-align:top;">País</td>
                <td style="padding:10px 0;">${pais}</td>
              </tr>
              <tr style="border-top:1px solid #EDD5DC;">
                <td style="padding:10px 0;color:#6B6B6B;vertical-align:top;">Punto del proceso</td>
                <td style="padding:10px 0;">${proceso || '—'}</td>
              </tr>
              <tr style="border-top:1px solid #EDD5DC;">
                <td style="padding:10px 0;color:#6B6B6B;vertical-align:top;">Objetivo</td>
                <td style="padding:10px 0;line-height:1.6;">${objetivo.replace(/\n/g, '<br/>')}</td>
              </tr>
              <tr style="border-top:1px solid #EDD5DC;">
                <td style="padding:10px 0;color:#6B6B6B;vertical-align:top;">¿Cómo supo?</td>
                <td style="padding:10px 0;">${como_supo || '—'}</td>
              </tr>
            </table>
    ...
    // ── 2. Correo de confirmación a la persona que solicita ─────────────────
    await resend.emails.send({
      from: FROM_ADDRESS,
      to: email,
        ...
        <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;color:#2A2A2A;">
          ...
          <div style="background:#FEF9FA;padding:32px;border-radius:0 0 12px 12px;border:1px solid #EDD5DC;">
            ...
            <p style="font-size:15px;line-height:1.7;color:#4A4A4A;margin:0 0 24px;">
              Si tienes cualquier duda urgente, puedes escribirme directamente a
    ...
    console.error('Error en ig-form:', error)
